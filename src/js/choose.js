$(document).ready(function () {
  ...
  // $("#add").click(function () {
  //   $("<br><br><select id='type'><option value='text'>文本</option><option value='date'>日期</option></select>").insertAfter("#preview");
  //   $("<input id='choose' type='button' value='选择'/>").insertAfter("select");
  // });
  // $('#choose-type').dialog({
  //   autoOpen:false,
  //   select:{
